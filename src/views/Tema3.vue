        ...
        AcordionA.mb-5(tipo="a" clase-tarjeta="tarjeta tarjeta--gris")(data-aos="fade-up")
          ...
          div(titulo="Impuesto al Valor Agregado (IVA)")
            .row.align-items-star.justify-content-center.p-4
              ...
              .col-lg-10.col-12
                img.d-none.d-sm-none.d-md-block(src='@/assets/curso/temas/tema3/fig_7.svg' alt="Imagen que contiene un esquema que hace mención del Impuesto del Valor Agregado, más conocido como IVA, destacando las tarifas del IVA para productos y servicios, así como los que están exentos.")
                img.d-block.d-md-none(src='@/assets/curso/temas/tema3/fig_7B.svg' lat="Imagen que contiene un esquema que hace mención del Impuesto del Valor Agregado, más conocido como IVA, destacando las tarifas del IVA para productos y servicios, así como los que están exentos.")
    ...
    .tarjeta--container.row.mb-5
      ...
      .col-md.tarjeta.color-primario.p-4(data-aos="fade-left")
        .row.justify-content-center.p-5.mb-3
          .col-6
            figure
              img(src='@/assets/curso/temas/tema3/ico_10.svg', alt="", style="width:150px; display:block; margin:0 auto;")
    ...
    TabsC.color-acento-contenido.mb-5(data-aos="zoom-in-down")
      .py-4.py-md-4.mg-top-2(titulo="Las contribuciones")
        .row.justify-content-center.p-5
          ...
          .col-12.col-md-5.mb-3.mb-md-0
            img(src="@/assets/curso/temas/tema3/img_2.png").m-auto
      ...
      .py-3.py-md-4.mg-top-2(titulo="Ejemplo contribuciones")
        .row.justify-content-center.align-items-center.p-4
          ...
          .col-12.col-md-5.mb-3.mb-md-0
            img(src="@/assets/curso/temas/tema3/img_3.png").m-auto
      ...
      .py-3.py-md-4.mg-top-2(titulo="Tasas")
        .row.justify-content-center.align-items-center.p-4
          ...
          .col-12.col-md-5.mb-3.mb-md-0
            img(src="@/assets/curso/temas/tema3/img_4.png").m-auto
